...
setup(
    ...
    name="speech_dataset_preparation",
    version="1.0.0",
    url="https://github.com/stefantaubert/speech-dataset-preparation.git",
    author="Stefan Taubert",
    author_email="stefan.taubert@posteo.de",
    description="Utils for text-to-speech preparation",
    packages=["speech_dataset_preparation"],
    install_requires=[
        "pandas",
        "matplotlib",
        "tqdm",
